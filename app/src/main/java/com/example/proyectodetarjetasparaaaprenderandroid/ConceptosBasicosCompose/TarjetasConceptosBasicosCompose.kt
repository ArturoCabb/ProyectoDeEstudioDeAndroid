...
class TarjetasConceptosBasicosCompose {
}
...
fun ArticuloCompose(modifier: Modifier = Modifier) {
    ...
    Column(
        ...
        Image(image, null, contentScale = ContentScale.Fit)
        Text(
        ...
        Text(
            "In this tutorial, you build a simple UI component with declarative functions. " +
                    "You call Compose functions to say what elements you want and the " +
                    "Compose compiler does the rest. Compose is built around Composable " +
                    "functions. These functions let you define your app\'s UI " +
                    "programmatically because they let you describe how it should look " +
                    "and provide data dependencies, rather than focus on the process of " +
